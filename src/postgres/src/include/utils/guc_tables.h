...
struct yb_shared_parameter
{
	char 	yb_proxy_client_id[6];	/* client_id generated by the yb_proxy */
	char 	parameter_value[20]; 	/* value of the parameter */
	char 	parameter_name[20]; 	/* value of the parameter */
};

struct list_changed_parameters
{
	char 	parameter_name[20]; 	/* name of the session parameter changed */
	struct list_changed_parameters *next;	/* next element in the list */
};
